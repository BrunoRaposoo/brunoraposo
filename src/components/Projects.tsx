  ...
  return (
    <RevealProjects>
      <div 
        ...
        <div className="absolute right-0 h-[288px] w-[526px] -translate-y-1/2 rounded-full bg-purple-700 opacity-50 blur-full" />
        <RevealTitle>
          <h1 
            className="flex h-16 sm:h-20 md:h-24 mt-5 items-center justify-center font-alt text-5xl md:text-6xl text-gray-50">
            <TypeIt
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mb-4 md:m-2 gap-7 place-content-center">
